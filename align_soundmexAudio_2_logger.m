...
pnames = {'Method', 'Session_strings','TTL_pulse_generator','TTL_pulse_recorder', 'Logger_list'};
dflts  = {'risefall',{'record only start' 'record only stop'},'MOTU','MOTU',[]};
[Method, Session_strings, TTL_pulse_generator, TTL_pulse_recorder, Logger_list] = internal.stats.parseArgs(pnames,dflts,varargin{:});
...
if strcmp(TTL_pulse_generator,'MOTU') && strcmp(TTL_pulse_recorder,'MOTU')
...
elseif strcmp(TTL_pulse_generator, 'Avisoft') && strcmp(TTL_pulse_recorder,'MOTU')
    ...
    TTL_param = load(fullfile(TTL_paramfile.folder, TTL_paramfile.name));
elseif strcmp(TTL_pulse_generator, 'Avisoft') && strcmp(TTL_pulse_recorder,'Avisoft')
...
elseif strcmp(TTL_pulse_recorder, 'Avisoft')
    save(fullfile(Audio_dir, sprintf('%s_TTLPulseTimes.mat', ExpDate)),'Pulse_idx', 'Pulse_TimeStamp_Transc', 'File_number', 'Pulse_samp_audio', 'Slope_and_intercept','Mean_std_x','Mean_std_Pulse_TimeStamp_Transc','Mean_std_Pulse_samp_audio');
end
